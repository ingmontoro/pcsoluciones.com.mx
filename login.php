...
<body>
	...
	<div class="div-bloqueo">
		...
		<div class="div-title">
				DEVDEVASD<span id="changer" style="cursor: pointer;"><span style="color:#00a1ec;"><?=substr($GLOBALS['config']['system_name'], 0, 1)?></span><span style="color:orange;"><?=substr($GLOBALS['config']['system_name'], 1, 1)?></span></span><?=substr($GLOBALS['config']['system_name'], 2)?>
			</div>
